...
// import './assets/css/CreateTemplates.css';
...
<Content>
        ...
        <div>
            <div className="headline" style={{marginLeft: '8%'}}>
                <span className="campaign-your-brand">Create New Template</span>
            </div>
            ...
            <Steps current={step} className="steps">
              ...
              <Steps.Item title="Step 2: Edit Template " className="progresssteps" />
...
<ButtonGroup className="buttonNext">
            ...
            {this.state.step !==2 && this.state.step !==2 && <Button appearance="primary" title="Next" style={{width: 150}} onClick={this.increase}  id="next">Next</Button>}
             
              {this.state.step ===2 && <Button appearance="primary" title="Save" style={{width: 150}} onClick={this.increase} >Save</Button>}
...
<Container style={{marginTop: 50}}>
    ...
    {this.state.step===1  && <StepTwoCustomize setClick={click => this.clickChild = click} parentMethod={this.increase}  />}
   
    
    {(this.state.step===2) && <Preview />}
...
export default connect(mapStateToProps)(CreateTemplates) 
