...
<Row style={{border: "1px solid #d9d9d9", background: "#efefef", borderTop: "none"}} className="TemplateList">
    ...
    <input type="radio" id="myCheckbox1" name="teamplateID"/>
              <label for="myCheckbox1"><img src="https://cms-assets.tutsplus.com/uploads/users/30/posts/9386/final_image/final-html-email-template.png" alt="template" style={{width: 300}}/>
              </label>
    </Col>
    <Col md={8} sm={12}>
